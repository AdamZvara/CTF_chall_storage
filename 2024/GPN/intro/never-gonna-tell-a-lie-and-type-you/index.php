...
function securePassword($user_secret){
    ...
    echo "secret: ", strval($user_secret);
    echo "\n";
    echo "md5: ", md5(strval($user_secret));
    echo "\n";
    echo "hexdec: ", hexdec(md5(strval($user_secret)));
    echo "\n";
    echo "substr: ", substr(hexdec(md5(strval($user_secret))),0,7);
    echo "\n";
    echo "o: ", $o;
    echo "\n";
    echo "final: ", $user_secret * $o;
    echo "\n";
